...
public class CommsEngine {
    ...
    private final String apikey = "45f2c1e5-ff3c-4811-b7d5-e3ac343b7d71";
    ...
    public void ServicePostRequestmethod(String serviceType, String fileType,Map<String,Object> param, OnServerRequestCompleteListener listener) {
        mListener = listener;
        httpMethod = HTTP_METHOD.POST;
        new MakeAsyncActivitiesTaskMethod().execute(serviceType, fileType, param);
    }
    ...
    class MakeAsyncActivitiesTaskMethod extends AsyncTask<Object, String, String> {
        @Override
        protected String doInBackground(Object... params)
        {
            String url = "";
            ...
            if (httpMethod == HTTP_METHOD.GET) {
                ...
                try {
                    ...
                    reqEntity.setMode(HttpMultipartMode.BROWSER_COMPATIBLE);
                    Map<String,Object> map = (Map) params[2];
                    reqEntity.addPart("apikey", new StringBody(apikey, ContentType.TEXT_PLAIN));
                    for (Map.Entry<String, Object> e : map.entrySet()) {
                        ...
                        if (key.equals("file")) {
                            ContentType type = ContentType.create((String) params[1], Consts.ISO_8859_1);
                            reqEntity.addBinaryBody("file",(byte[]) value, type, "");
                        } else
                            reqEntity.addPart(key, new StringBody(value.toString(), ContentType.TEXT_PLAIN));
                    }
                    httpPost.setEntity(reqEntity.build());
                } catch (URISyntaxException e) {
                    mListener.onErrorOccurred(e.getMessage());
